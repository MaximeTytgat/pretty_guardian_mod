...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    private void BottomTopblockWithItem(Block block) {
        simpleBlockWithItem(block, models().cubeBottomTop(
                name(block),
                blockTexture(block),
                new ResourceLocation(PrettyGuardian.MOD_ID, "block/" + name(block) + "_bottom"),
                new ResourceLocation(PrettyGuardian.MOD_ID, "block/" + name(block) + "_top")
        ));
    }

    private void topblockWithItem(Block block) {
        simpleBlockWithItem(block, models().cubeTop(name(block), blockTexture(block), new ResourceLocation(PrettyGuardian.MOD_ID, "block/" + name(block) + "_top")));
    }
    ...
    private ConfiguredModel[] strawberryStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((StrawberryCropBlock) block).getAgeProperty()),
                new ResourceLocation(PrettyGuardian.MOD_ID, "block/" + textureName + state.getValue(((StrawberryCropBlock) block).getAgeProperty()))).renderType("cutout"));
    ...
    private ConfiguredModel[] mintStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().crop(modelName + state.getValue(((MintCropBlock) block).getAgeProperty()),
                new ResourceLocation(PrettyGuardian.MOD_ID, "block/" + textureName + state.getValue(((MintCropBlock) block).getAgeProperty()))).renderType("cutout"));
    ...
    private ConfiguredModel[] vanillaStates(BlockState state, CropBlock block, String modelName, String textureName) {
        ...
        models[0] = new ConfiguredModel(models().singleTexture(
                ...
                new ResourceLocation(PrettyGuardian.MOD_ID, "block/crop_cross_double"),
                "cross",
                new ResourceLocation(PrettyGuardian.MOD_ID, "block/" + textureName + state.getValue(((VanillaCropBlock) block).getAgeProperty()))
        ).renderType("cutout"));
