package com.doudou.prettyguardian.item;
...
import com.doudou.prettyguardian.item.custom.*;
import com.doudou.prettyguardian.item.custom.food.ClassicDonut;
import com.doudou.prettyguardian.item.custom.food.ReusableFoodContainerItem;
import com.doudou.prettyguardian.item.custom.projectiles.CuteArrowItem;
import com.doudou.prettyguardian.item.custom.projectiles.HeartItem;
import com.doudou.prettyguardian.item.custom.projectiles.StarLightItem;
import com.doudou.prettyguardian.item.custom.tool.*;
...
public class PrettyGuardianItem {
    ...
    public static final RegistryObject<Item> PISTACHIO_ICE_CREAM = ITEMS.register("pistachio_ice_cream", () -> new ReusableFoodContainerItem(new Item.Properties().food(ModFoods.ICE_CREAM), 32, PrettyGuardianItem.ICE_CREAM_CUP));
