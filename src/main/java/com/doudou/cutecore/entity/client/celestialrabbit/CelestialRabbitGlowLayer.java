...
public class CelestialRabbitGlowLayer<T extends CelestialRabbitEntity, M extends CelestialRabbitModel<T>> extends RenderLayer<T, M> {
    private static final RenderType RABBIT_LIGHT_TEXTURE = RenderType.entityTranslucentEmissive(new ResourceLocation(CuteCore.MOD_ID, "textures/entity/rabbit/celestial/celestial_rabbit_glow.png"));
