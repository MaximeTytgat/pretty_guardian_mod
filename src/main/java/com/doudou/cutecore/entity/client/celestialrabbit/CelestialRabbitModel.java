...
import com.doudou.cutecore.entity.animations.ModAnimationDefinitions;
...
public class CelestialRabbitModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(CuteCore.MOD_ID, "celestial_rabbit"), "main");
