...
public class CelestialRabbitRenderer extends MobRenderer<CelestialRabbitEntity, CelestialRabbitModel<CelestialRabbitEntity>> {
    private static final ResourceLocation CELESTIAL_RABBIT_LOCATION = new ResourceLocation(CuteCore.MOD_ID, "textures/entity/rabbit/celestial/celestial_rabbit.png");
    private static final ResourceLocation CELESTIAL_RABBIT_ANGRY_LOCATION = new ResourceLocation(CuteCore.MOD_ID, "textures/entity/rabbit/celestial/celestial_rabbit_angry.png");
