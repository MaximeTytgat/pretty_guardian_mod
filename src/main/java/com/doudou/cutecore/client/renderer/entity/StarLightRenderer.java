...
public class StarLightRenderer extends EntityRenderer<StarLightEntity> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(CuteCore.MOD_ID, "textures/entity/projectiles/star_light.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public StarLightRenderer(EntityRendererProvider.Context p_173962_) {
        super(p_173962_);
    }

    @Override
    public ResourceLocation getTextureLocation(StarLightEntity p_114482_) {
        return TEXTURE_LOCATION;
    }

    protected int getBlockLightLevel(StarLightEntity p_114087_, BlockPos p_114088_) {
        return 15;
    }

    public void render(StarLightEntity p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.pushPose();
