...
@OnlyIn(Dist.CLIENT)
public class CuteArrowRenderer extends EntityRenderer<CuteArrow> {
    public CuteArrowRenderer(EntityRendererProvider.Context p_173917_) {
        super(p_173917_);
    }
    public static final ResourceLocation CUTE_ARROW_TEXTURE_LOCATION = new ResourceLocation("textures/entity/projectiles/spectral_arrow.png");

    public @NotNull ResourceLocation getTextureLocation(CuteArrow arrow) {
        Item referenceItem = arrow.getPickupItem().getItem();
        CuteCore.LOGGER.info("referenceItem: " + new ResourceLocation(CuteCore.MODID, "textures/entity/projectiles/cute_arrow.png"));
        return CUTE_ARROW_TEXTURE_LOCATION;
    }
    public void render(CuteArrow p_113839_, float p_113840_, float p_113841_, PoseStack p_113842_, MultiBufferSource p_113843_, int p_113844_) {
        p_113842_.pushPose();
