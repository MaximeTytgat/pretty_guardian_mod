...
//    private static final EntityDataAccessor<Integer> ID_EFFECT_COLOR = SynchedEntityData.defineId(CuteArrow.class, EntityDataSerializers.INT);
//    private static final byte EVENT_POTION_PUFF = 0;
//    private Potion potion = Potions.EMPTY;
//    private final Set<MobEffectInstance> effects = Sets.newHashSet();
//    private boolean fixedColor;
//
//    public CuteArrow(EntityType<? extends CuteArrow> p_36858_, Level p_36859_) {
//        super(p_36858_, p_36859_);
//    }
//
//    public CuteArrow(Level p_36861_, double p_36862_, double p_36863_, double p_36864_) {
//        super(EntityType.ARROW, p_36862_, p_36863_, p_36864_, p_36861_);
//    }
//
//    public CuteArrow(Level level, LivingEntity livingEntity) {
//        super(CuteArrow, level);
//    }
...
//            }
//        } else if (p_36879_.is(CuteCoreItem.CUTE_ARROW.get())) {
...
//            return new ItemStack(CuteCoreItem.CUTE_ARROW.get());
//        } else {
