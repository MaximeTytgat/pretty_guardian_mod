...
public class CuteBowItem extends ProjectileWeaponItem implements Vanishable  {
    ...
    public void releaseUsing(ItemStack p_40667_, Level p_40668_, LivingEntity p_40669_, int p_40670_) {
        if (p_40669_ instanceof Player player) {
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    boolean flag1 = player.getAbilities().instabuild || (itemstack.getItem() instanceof CuteArrowItem && ((CuteArrowItem)itemstack.getItem()).isInfinite(itemstack, p_40667_, player));
                    if (!p_40668_.isClientSide) {
                        CuteArrowItem arrowitem = (CuteArrowItem)(itemstack.getItem() instanceof CuteArrowItem ? itemstack.getItem() : CuteCoreItem.CUTE_ARROW.get());
                        CuteAbstractArrow abstractarrow = arrowitem.createArrow(p_40668_, itemstack, player);
                        ...
                        if (flag1 || player.getAbilities().instabuild && (itemstack.is(Items.SPECTRAL_ARROW) || itemstack.is(Items.TIPPED_ARROW))) {
                            abstractarrow.pickup = CuteAbstractArrow.Pickup.CREATIVE_ONLY;
                        }
    ...
    public CuteAbstractArrow customArrow(CuteAbstractArrow arrow) {
        return arrow;
    }
