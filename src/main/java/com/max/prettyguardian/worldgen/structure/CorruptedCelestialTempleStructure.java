...
public class CorruptedCelestialTempleStructure extends Structure {
    ...
    public static final Codec<CorruptedCelestialTempleStructure> CODEC = RecordCodecBuilder.<CorruptedCelestialTempleStructure>mapCodec(instance ->
            instance.group(CorruptedCelestialTempleStructure.settingsCodec(instance),
            ...
            ).apply(instance, CorruptedCelestialTempleStructure::new)).codec();
    ...
    public CorruptedCelestialTempleStructure(Structure.StructureSettings config,
