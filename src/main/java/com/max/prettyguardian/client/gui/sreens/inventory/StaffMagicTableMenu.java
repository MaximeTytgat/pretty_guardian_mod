...
import com.max.prettyguardian.blocks.entity.StaffMagicTableBlockEntity;
...
public class StaffMagicTableMenu extends AbstractContainerMenu {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(this.level, this.blockEntity.getBlockPos()), player, PrettyGuardianBlock.STAFF_MAGIC_TABLE.get());
    }
