...
import com.max.prettyguardian.item.custom.food.DrinkableFood;
...
public class PrettyGuardianItem {
    ...
    public static final RegistryObject<Item> STRAWBERRY_MILK_CARTON = ITEMS.register("strawberry_milk_carton", () -> new DrinkableFood(new Item.Properties().food(ModFoods.MILK_CARTON)));
    public static final RegistryObject<Item> CHOCOLATE_MILK_CARTON = ITEMS.register("chocolate_milk_carton", () -> new DrinkableFood(new Item.Properties().food(ModFoods.MILK_CARTON)));
    public static final RegistryObject<Item> VANILLA_MILK_CARTON = ITEMS.register("vanilla_milk_carton", () -> new DrinkableFood(new Item.Properties().food(ModFoods.MILK_CARTON)));
